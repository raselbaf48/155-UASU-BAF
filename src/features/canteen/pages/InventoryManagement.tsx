                 ...
                 return (
                  <tr key={row.id} className="hover:bg-slate-800 dark:hover:bg-slate-800/20 transition-colors">
                     ...
                     <td className="px-6 py-4 text-right font-black text-lg">
                        {formatNumber(row.stock, i18n.language)} <span className="text-xs font-medium text-slate-400 ml-1">{isLangBn ? row.unit_bn : row.unit_en}</span>
                     </td>
                     ...
                     <td className="px-6 py-4 text-right">
                        <button className="text-slate-400 hover:text-emerald-600 font-bold text-xs bg-slate-800 hover:bg-emerald-900/30 px-3 py-1.5 rounded-lg transition-colors border border-slate-700">
                           Manage
                        </button>
                     </td>
                  </tr>
