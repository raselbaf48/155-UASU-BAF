...
export const Settings: React.FC = () => {
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6 animate-in fade-in duration-300">
      ...
      <div className="bg-slate-900 dark:bg-slate-900 rounded-2xl border border-slate-700 dark:border-slate-800 overflow-hidden shadow-sm p-6 space-y-6">
         <div>
            <h3 className="text-lg font-bold flex items-center space-x-2 mb-4 text-white dark:text-white">
         ...
         <div>
            ...
            <input type="time" defaultValue="15:30" className="w-full md:w-1/2 px-4 py-2 bg-slate-800 dark:bg-slate-800 border border-slate-700 dark:border-slate-700 rounded-xl focus:outline-none focus:ring-2 focus:ring-emerald-500 font-medium" />
         </div>
      </div>
    </div>
  );
