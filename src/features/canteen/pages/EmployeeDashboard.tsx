...
export const EmployeeDashboard: React.FC = () => {
  ...
  return (
    <div className="max-w-6xl mx-auto space-y-6 animate-in fade-in duration-300">
      ...
      {/* Top Banner */}
      <div className="flex flex-col md:flex-row bg-white rounded-[2rem] shadow-sm border border-slate-100 overflow-hidden h-auto md:h-40">
         {/* Left Side */}
         <div className="md:w-1/2 bg-[#0f172a] text-white p-8 flex flex-col justify-center items-center relative overflow-hidden">
            ...
            <Utensils className="absolute w-64 h-64 text-slate-800 opacity-20 -right-10 -bottom-10" />
         ...
         <div className="md:w-1/2 p-8 flex items-center justify-between">
            <div className="flex items-center space-x-4">
               ...
               <div>
                  <p className="text-[10px] font-black text-[#4f46e5] uppercase tracking-widest">RUNNING MANAGER</p>
                  <p className="text-xl font-bold text-slate-900 leading-tight">LAC Nishad</p>
                  <p className="text-xs font-bold text-slate-400">+880 1601-676760</p>
               </div>
            </div>
            <button className="px-6 py-3 rounded-full bg-[#4f46e5] hover:bg-[#4338ca] text-white text-xs font-bold tracking-widest transition-all shadow-md shadow-indigo-500/30">
               PERSONAL PORTAL
            </button>
         </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
         ...
         <div className="lg:col-span-2 bg-white rounded-[2rem] p-8 shadow-sm border border-slate-100 flex flex-col min-h-[400px]">
            <h3 className="text-sm font-black text-slate-800 tracking-widest uppercase mb-8 flex items-center space-x-2">
            ...
            <div className="bg-[#0f172a] rounded-[2rem] p-8 shadow-xl shadow-slate-900/10">
               ...
               <div className="space-y-4">
                  <input 
                     ...
                     className="w-full bg-[#1e293b] text-white px-5 py-4 rounded-2xl text-xs font-bold tracking-widest focus:outline-none focus:ring-2 focus:ring-[#4f46e5] placeholder:text-slate-500 border border-slate-800 text-center"
                  />
