...
const regex = /<div className="flex flex-col md:flex-row items-center justify-between mb-4 gap-4">.*?<\/div>\s*\}\s*<\/div>\s*<\/div>/s;
...
const replacement = `<div className="flex flex-col items-center justify-center mb-4 gap-4 relative">
          ...
          <div className="flex flex-col items-center justify-center gap-3 w-full">
            ...
            {isCalendarOpen && (
              <div className="max-w-sm border border-slate-200 dark:border-slate-700/50 rounded-xl overflow-hidden bg-slate-50 dark:bg-slate-900/50 shadow-lg absolute top-[100px] z-20">
