...
// Find where the edit form starts
const startIdx = content.indexOf('{editingGroup ? (');
const endIdx = content.indexOf('<div className="flex items-center gap-3 pt-2">', startIdx);
...
content = content.substring(0, startIdx) + UI + content.substring(endIdx + 45); // + 45 to jump over '<div className="flex items-center'
