...
// The start of the editing forms block
const startMarker = '                      {editingGroup[0].dutyCode === \'LEAVE\' ? (';
const startIndex = content.indexOf(startMarker);

// Find the corresponding end.
// We look for the closing of this block. It ends with:
/*
                      )}
                    </div>
...
*/
const endMarker = '                    <div className="flex items-center justify-end space-x-2 pt-2 border-t border-slate-100 dark:border-slate-800">';
...
const leaveUI = `
                      ...
                      ) : editingGroup[0].dutyCode === 'ATT' || editingGroup[0].dutyCode === 'DEPLOYMENT' ? (
                        <>
                          <div className="grid grid-cols-2 gap-3">
                            <div>
                              <label className="block text-[11px] font-bold text-slate-600 dark:text-slate-400 mb-1 uppercase tracking-wider">From Date</label>
                        ...
                        <div className="space-y-4">
                          ...
                          <div>
                            ...
                            <input
                              ...
                              value={editNotes}
                              onChange={(e) => setEditNotes(e.target.value)}
                              placeholder="E.g. specific reason, etc."
...
content = content.substring(0, startIndex) + leaveUI + content.substring(endIndex);
